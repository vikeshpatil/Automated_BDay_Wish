...
def save_txt():
    ...
    with open(dir_path + '/credentials/text.txt', 'a') as f:
        ...
        f.write(str(fname_field.get()) + " " + str(lname_field.get()) + " " + str(mobile_field.get())
...
if __name__ == "__main__":
    ...
    heading = Label(root, text="Fill the information for contacts", bg="light green", width=30, height=2, font=("Calibri", 15))

    fname = Label(root, text="First Name", bg="light green")

    lname = Label(root, text="Last Name", bg="light green")

    mobile = Label(root, text="Mobile Number", bg="light green")

    email = Label(root, text="Email", bg="light green")

    dob= Label(root, text="Date Of Birth(yyyy-mm-dd)", bg="light green")

    wgroup = Label(root, text="Whatsapp Group Name", bg="light green")

    fgroup = Label(root, text="Facebook Group Name", bg="light green")
